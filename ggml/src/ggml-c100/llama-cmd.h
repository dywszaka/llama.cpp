...
#define CMD_SOFTMAX_EXT_MAGIC       LLAMA_SOFTMAX_EXT_MAGIC
#define CMD_SOFTMAX_FLAG_HAS_MASK   LLAMA_SOFTMAX_FLAG_HAS_MASK
#define CMD_SOFTMAX_FLAG_F32        LLAMA_SOFTMAX_FLAG_F32
#define CMD_SOFTMAX_FLAG_SHAPE4D    LLAMA_SOFTMAX_FLAG_SHAPE4D
#define CMD_FLAG_EXT_PARAM          LLAMA_CMD_FLAG_EXT_PARAM

#define CMD_SOFTMAX_PACK_U16_PAIR(low, high) \
    LLAMA_SOFTMAX_PACK_U16_PAIR(low, high)
