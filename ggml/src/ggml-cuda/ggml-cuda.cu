...
#include "ggml-cuda/bf16-round.cuh"
...
#include "ggml-cuda/expt/nvfp4/nvfp4-8-kq.cuh"
#include "ggml-cuda/expt/nvfp4/kcache-outlier.cuh"
#include "ggml-cuda/expt/nvfp4/nvfp4-matmul.cuh"
#include "ggml-cuda/expt/nvfp4/vcache-nvfp4-matmul.cuh"
...
static void ggml_cuda_mul_mat(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    if (!split && use_mul_mat_vec_f) {
        ...
        ggml_cuda_f16_kcache_outlier_apply_correction(ctx, src0, src1, dst);
