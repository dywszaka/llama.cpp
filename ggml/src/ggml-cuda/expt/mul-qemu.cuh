...
enum ggml_cuda_mul_qemu_mode {
    GGML_CUDA_MUL_QEMU_MODE_CUDA = 0,
    GGML_CUDA_MUL_QEMU_MODE_QEMU,
    GGML_CUDA_MUL_QEMU_MODE_QEMU_CUDA,
    GGML_CUDA_MUL_QEMU_MODE_COMPARE,
};

struct ggml_cuda_mul_qemu_params {
...
using ggml_cuda_mul_launch_fn = void (*)(
