...
__device__ int ggml_cuda_nvfp4_tile_xy_dbg_once = 0;
...
// Explicit instantiation for NVFP4
template void mul_mat_q_case<GGML_TYPE_NVFP4>(ggml_backend_cuda_context & ctx, const mmq_args & args, cudaStream_t stream);
