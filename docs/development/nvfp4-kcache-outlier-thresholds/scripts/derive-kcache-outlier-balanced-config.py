...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-layer-count", type=float, default=None,
                        help="reject per-layer options above this count; default is 4 * target-count")
...
def choose_profile(args: argparse.Namespace) -> dict[str, Any]:
    ...
    max_layer_count = args.max_layer_count
    if max_layer_count is None:
        max_layer_count = args.target_count * 4.0
...
def write_outputs(profile: dict[str, Any], output_dir: Path) -> None:
    ...
    header = []
    header.append("// Generated by docs/development/nvfp4-kcache-outlier-thresholds/scripts/derive-kcache-outlier-balanced-config.py")
