...
LOG = EXP / "runs" / "fourth_ctx8192_profile.raw.log"
RESULTS = EXP / "results"
...
CTX8192_CAPACITY = {
    0: 0, 1: 0, 2: 695, 3: 72, 4: 0, 5: 0, 6: 0, 7: 68, 8: 0,
    9: 14, 10: 0, 11: 0, 12: 0, 13: 29, 14: 0, 15: 46, 16: 174, 17: 31,
    18: 409, 19: 16, 20: 129, 21: 564, 22: 580, 23: 0, 24: 17, 25: 128,
    26: 26, 27: 77, 28: 28, 29: 29, 30: 1664, 31: 30, 32: 8, 33: 18,
    34: 1667, 35: 0,
}
...
def write_outputs():
    ...
    summary = ["# K-cache Outlier ctx8192 Profile", ""]
    summary.append("Profile target: current fourth-case configuration at `-c 8192`.")
    summary.append("")
    ...
    summary.append("")
    summary.append("- Raw log: `runs/fourth_ctx8192_profile.raw.log`")
