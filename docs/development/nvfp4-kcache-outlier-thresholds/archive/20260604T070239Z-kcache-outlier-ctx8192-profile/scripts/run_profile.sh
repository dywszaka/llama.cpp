...
EXP_DIR="${ROOT_DIR}/experiments/20260604T070239Z-kcache-outlier-ctx8192-profile"
...
LOG="${EXP_DIR}/runs/fourth_ctx8192_profile.raw.log"

mkdir -p "${EXP_DIR}/runs" "${EXP_DIR}/results"

{
  echo "case=fourth_ctx8192_profile"
