...
EXP_DIR="${ROOT_DIR}/experiments/20260604T071706Z-kcache-outlier-ctx8192-capacity-fix-v2"
...
LOG="${EXP_DIR}/runs/fourth_ctx8192_capacity_fix_v2.raw.log"

mkdir -p "${EXP_DIR}/runs" "${EXP_DIR}/results"

{
  echo "case=fourth_ctx8192_capacity_fix_v2"
