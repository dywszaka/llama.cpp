...
LOG = EXP / "runs" / "fourth_ctx8192_capacity_fix_v2.raw.log"
RESULTS = EXP / "results"
...
CTX8192_CAPACITY = {
    ...
    9: 14, 10: 0, 11: 0, 12: 0, 13: 29, 14: 0, 15: 78, 16: 314, 17: 67,
    18: 532, 19: 49, 20: 168, 21: 609, 22: 875, 23: 0, 24: 17, 25: 207,
    26: 26, 27: 124, 28: 114, 29: 60, 30: 1885, 31: 66, 32: 85, 33: 18,
    34: 2012, 35: 0,
}
...
def write_outputs():
    ...
    summary = ["# K-cache Outlier ctx8192 Capacity Fix v2 Validation", ""]
    ...
    summary.append("")
    summary.append("- Raw log: `runs/fourth_ctx8192_capacity_fix_v2.raw.log`")
