...
#ifdef GGML_USE_CUDA
        const bool experimental_kv_convert = !kv_nvfp4_fp8_f32_ref && cparams.offload_kqv && llama_graph_env_enabled("LLAMA_EXPERIMENTAL_KV_CONVERT");
#else
...
ggml_tensor * llm_graph_context::build_attn_with_sinks(
    ...
    ggml_tensor * cur = build_attn_mha(q, k, v, kq_b, kq_mask, v_mla, sinks, kq_scale, il);
    cb(cur, "kqv_out", il);
